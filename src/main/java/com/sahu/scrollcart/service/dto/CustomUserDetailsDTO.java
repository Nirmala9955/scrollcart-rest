package com.sahu.scrollcart.service.dto;
...
public class CustomUserDetailsDTO extends User {
	...
	public CustomUserDetailsDTO(String username, String password, Collection<? extends GrantedAuthority> authorities,
			Long userId, String uuid, String fullName, String email, String phoneNo, List<String> userRoles, List<String> userPermissions) {
		super(username, password, authorities);
		this.userId = userId;
		this.uuid = uuid;
