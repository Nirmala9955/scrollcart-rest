...
import com.sahu.scrollcart.constants.MailConstants;
...
public class MailSenderUtil {
	...
	public String sendWelcomeAndActiveAccountMail(User user, String siteURL, String otp) throws MessagingException {
		...
		replacements.put(MailConstants.OTP, otp);
	...
	public String sendMailForResetPassword(User user, String siteURL, String otp)
